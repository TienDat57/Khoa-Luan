...
set_argument = set()
with open("./dataset/genAll/error.txt","w") as err:
    with open("./dataset/genAll/train.tsv","w", encoding="utf-8") as rs1:
        with open("./dataset/genAll/dev.tsv","w", encoding="utf-8") as dev1:
            with open("./dataset/genAll/test.tsv","w", encoding="utf-8") as test1:
