...
import collections
import os
import biobert_v1.modeling as modeling
import biobert_v1.optimization as optimization
import biobert_v1.tokenization as tokenization
import tensorflow as tf
from tensorflow.python.ops import math_ops
import biobert_v1.tf_metrics as tf_metrics
import pickle
flags = tf.flags
...
def main(_):
    ...
    bert_config = modeling.BertConfig(vocab_size=28996, hidden_size=768, num_hidden_layers=12, num_attention_heads=12, intermediate_size=3072, hidden_act="gelu", hidden_dropout_prob=0.1, attention_probs_dropout_prob=0.1, max_position_embeddings=512, type_vocab_size=2, initializer_range=0.02)
